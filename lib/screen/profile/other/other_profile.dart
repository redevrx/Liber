...
class OtherProfileScreen extends StatelessWidget {
          ...
          SliverBox(
              ...
              child: Column(
                children: [
                  ...
                  _infoCard(context),
                  SizedBox(height: size.height * .02),
                  ///btn friend status and send message
                  _rowButton(size, context),
                  SizedBox(height: size.height * .02),
                  /// friend list
                  LimitedBox(
  ...
  Widget _rowButton(Size size, BuildContext context) {
    return Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.yellow,
                        borderRadius: BorderRadius.circular(kDefault / 0.6),
                        boxShadow: const [
                          BoxShadow(
                            color: kDark,
                            offset: Offset(0,.5),
                      ...
                      child: Text('Friend Status',style: kFontLabelSmall(context)?.copyWith(fontWeight: FontWeight.w700),),
                    ),
                    Container(
                      ...
                      child: Text('Message',style: kFontLabelSmall(context)?.copyWith(color: Colors.white,fontWeight: FontWeight.w700),),
                    )
                  ],
                );
  }
